...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.balance'
        db.add_column(u'www_node', 'balance',
                      self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=19, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.balance'
        db.delete_column(u'www_node', 'balance')
    ...
    models = {
        ...
        u'www.node': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 4, 1, 0, 0)'}),
            ...
            'money': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '19', 'decimal_places': '2'}),
        ...
        u'www.profile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_outdate': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'stocks_num': ('django.db.models.fields.IntegerField', [], {'default': "'0'"}),
            'stocks_raw': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'stocks_val': ('django.db.models.fields.DecimalField', [], {'default': "'0'", 'max_digits': '19', 'decimal_places': '2'}),
