...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Node.money'
        db.add_column(u'www_node', 'money',
                      self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=19, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Node.money'
        db.delete_column(u'www_node', 'money')
    ...
    models = {
        ...
        u'www.node': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 1, 0, 0)'}),
